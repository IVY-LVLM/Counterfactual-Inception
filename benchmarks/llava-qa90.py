...
class LLaVAQA90Dataset(BaseEvalDataset):
    def __init__(self, data_path: str = "llava-qa90", default_output_path="LLaVA-QA90", counterfactual = False, counterfactual_path = "", contradiction_threshold=-1.0, clip_lower_threshold=-1.0, clip_upper_threshold=-1.0):
        super().__init__("llava-qa90", data_path, counterfactual=counterfactual, contradiction_threshold=contradiction_threshold, clip_lower_threshold=clip_lower_threshold, clip_upper_threshold=clip_upper_threshold)
