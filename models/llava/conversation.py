...
class Conversation:
    ...
    def get_llava_response_prompt(self, dataset_name):
        ...
        elif dataset_name in ["llavabench", "mmvp"]:
            return ""
...
conv_counterfactual = Conversation(
    system="Note: The previously generated description was counterfactual and non-factual. "
           "The assistant gives helpful and detailed answer based on the factual information of the original image, disregarding any imaginative or speculative details mentioned in the previously generated counterfactual description.",
    roles=("Human", "Assistant"),
    messages=(
    ),
    offset=0,
...
conv_templates = {
    ...
    "counterfactual": conv_counterfactual,
